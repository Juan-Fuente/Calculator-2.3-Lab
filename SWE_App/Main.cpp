    ...
    : wxFrame(nullptr, wxID_ANY, "Calculator")
{
    ...
    calculatorTyper->Add(new wxTextCtrl(this, 200, "", wxPoint(-1, -1), wxSize(-1, 75), wxTE_RIGHT | wxTE_READONLY | wxTE_NO_VSCROLL), 0, wxEXPAND | wxTOP | wxBOTTOM, 4);
    wxFont numbersAdded = wxFont(25, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false);
